...
== Usage
This will copy over all the views needed for the application. It should be using Rails 3.1+ so all the assets will be included in the pipeline by default. 

  $ rails generate rw_depot_theme:setup
